/**
 * PageLayout — wraps all inner app pages (dashboard, profile, etc.)
 * Landing page does NOT use this — it has full cinematic control.
 */
...
export default function PageLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-surface-900">
      ...
      <main className="relative z-10 lg:pl-64 pt-16">
        <motion.div

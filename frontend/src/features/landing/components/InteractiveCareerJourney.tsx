...
export const InteractiveCareerJourney: React.FC = () => {
  ...
  const steps: Step[] = [
    {
      ...
      description:
        'Input your target job title or explore market trends. SkillBridge establishes your baseline career profile and target benchmarks.',
      icon: Compass,
    ...
    },
    {
      ...
      description:
        'Upload your current resume. NLP models extract hard skills, frameworks, domain experience, and ATS keyword metrics automatically.',
      icon: FileCheck,
    ...
    },
    {
      ...
      description:
        'AI compares your capability matrix against real market requirements to pinpoint high-priority missing skills.',
      icon: Search,
    ...
    },
    {
      ...
      description:
        'SkillBridge generates a week-by-week curriculum with curated resources, capstone projects, and recommended certifications.',
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        'As you complete roadmap milestones, your Career Readiness Score climbs toward the target 90%+ interview threshold.',
      icon: Trophy,
    ...
    },
    {
      ...
      description:
        'Armed with verified skills, an ATS-hardened resume, and capstone projects, you secure your dream career role.',
      icon: Briefcase,
  ...
  return (
    <section id="journey" className="py-24 px-4 max-w-7xl mx-auto relative">
      {/* Section Header */}
      ...
      {/* Active Step Glass Detail Card */}
      {(() => {
        const currentStep = steps.find((s) => s.number === activeStep) || steps[0];
        const Icon = currentStep.icon;

        return (
          <TiltCard glowColor="rgba(99, 102, 241, 0.2)" className="p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              {/* Action Side Display */}
              <div className="lg:col-span-4 flex flex-col justify-center items-center p-6 rounded-2xl bg-linear-to-b from-indigo-900/30 to-purple-900/20 border border-white/10 text-center space-y-4">
                ...
                <h4 className="text-base font-bold text-white">Step {currentStep.number} Complete</h4>
